...
import { addArtifact, delArtifact, activateArtifact, completeArtifact, closeArtifact, isActive } from "@body";
...
const handleClose = () => closeArtifact(dependencies, props.artifact.id);
</script>
...
<template>
  ...
  <actions-menu class="outline-item-actions">
    ...
    <actions-item v-if="!showActivate" @click="handleClose">{{ t("page-outline.close") }}</actions-item>
    <actions-divider />

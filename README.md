...
This project was made possible thanks to the incredible power of open source projects like [CodeMirror](https://codemirror.net/), [PDF.js](https://github.com/mozilla/pdf.js/), [Phosphor](https://phosphoricons.com/), [PrimeVue](https://primevue.org/), and [Vue](https://vuejs.org/).

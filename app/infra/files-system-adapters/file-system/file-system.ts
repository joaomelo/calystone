import type { Artifact, ArtifactOptions, Directory, DirectoryOptions, Node } from "@/domain";
import type { Status } from "@/utils";

export type ArtifactOrDirectoryOptions = ArtifactOptions | DirectoryOptions;

export interface FileSystemAdapter {
  createArtifact(options: { name: string, parent: Directory }): Promise<ArtifactOptions>;
  createDirectory(options: { name: string, parent: Directory }): Promise<DirectoryOptions>;

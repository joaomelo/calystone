...
export function throwEmergency(code: string, cause: unknown) {
  throwException(code, cause, Severity.Emergency);
}

export function throwAlert(code: string, cause: unknown) {
  throwException(code, cause, Severity.Alert);
}

export function throwCritical(code: string, cause: unknown) {
  throwException(code, cause, Severity.Critical);
}

export function throwError(code: string, cause: unknown) {
  throwException(code, cause, Severity.Error);
}

export function throwWarning(code: string, cause: unknown) {
  throwException(code, cause, Severity.Warning);
}

export function throwNotice(code: string, cause: unknown) {
  throwException(code, cause, Severity.Notice);
}

export function throwInfo(code: string, cause: unknown) {
  throwException(code, cause, Severity.Info);
}

export function throwDebug(code: string, cause: unknown) {

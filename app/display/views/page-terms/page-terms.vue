...
<template>
  <div>
    ...
    2. Description of Calystone
    Calystone is an open-source, self-management application that integrates with:

    Local file systems via the File System Access API
    Third-party file services (Google Drive, OneDrive, Dropbox, etc.)
    ...
    Integration with File Services:
    Calystone may request permissions to read, edit, and save your files when you opt to connect it with third-party cloud services. Use of these third-party services is governed by each provider’s terms and policies (e.g., Google Drive, OneDrive, Dropbox).
    ...
    Open-Source Project; “As Is”
    Calystone is provided on an “as is” and “as available” basis, without warranties of any kind. Calystone is in early development and may not be fully stable or functional.
    No Guarantees:
    ...
    8. Indemnification
    You agree to indemnify and hold harmless Calystone, its contributors, and maintainers from any claims, liabilities, damages, losses, or expenses (including reasonable attorneys’ fees) arising out of or in any way connected with:

    Your access to or use of Calystone
